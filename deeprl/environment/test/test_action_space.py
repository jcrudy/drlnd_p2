from deeprl.environment.base import CartesianProductActionSpace,\
    ActionValueError, FloatInterval, IntInterval
from nose.tools import assert_raises
import numpy as np

def test_cartesian_product_action_space():
    action_space = CartesianProductActionSpace(
    ...
    assert_raises(ActionValueError, action_space.validate, invalid_action)
    
    assert_raises(AssertionError, assert_raises, ActionValueError, action_space.validate, valid_action)
